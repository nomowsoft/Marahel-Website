  ...
  return (
    <section className="bg-works bg-right bg-contain bg-no-repeat" id="works">
        <div className="mx-5 lg:mx-10 xl:mx-20 pt-20 lg:pt-12 pb-10">
            ...
            <p className="mt-6 text-xl lg:text-2xl text-center max-w-screen-md mx-auto text-gray-500 font-semibold font-js">
                {t('description')}
            </p>
                        ...
                        <SwiperSlide key={work.id} className="bg-white p-5 rounded-md shadow-lg border border-success">
                            <a href={work.href} target={work.href !== "#works" ? '_blank' : ''}>
                               <div className="h-64 flex flex-col ">
                                    <div className="h-20 flex justify-center items-center mx-auto my-8">
                                        <Image
                                            src={work.image}
                                            alt=""
                                            width={10}
                                    ...
                                    <div className="mt-4">
                                        <p className="text-lg text-gray-600 text-center font-js font-bold">
                                            {work.description}
                                        </p>
                                    </div>
                                </div>
