  ...
  return (
    <section className="bg-hero bg-cover bg-no-repeat">
        <div className="py-12 mx-5 md:mx-20">
            <div className="grid grid-cols-12 gap-4">
                <div className="col-span-12 md:col-span-7 flex justify-center items-center">
                    <div>
                        ...
                        <p className="text-xl lg:text-2xl xl:text-3xl mt-10 font-normal text-justify lg:ml-20">
                        ...
                        <div className="mt-10">
                            <button className="mx-2 bg-primary border border-primary py-3 px-4 rounded-md flex justify-center items-center">
                                ...
                                <Image height={20} width={20} src="/hero/Paper.png" alt="phone" />
                            </button>
                        </div>
                    </div>
                </div>
            ...
            <div className="py-12">
                <h1 className="text-center text-3xl lg:text-5xl text-primary font-extrabold">الإتفاقيات</h1>
            ...
            <div className="py-12">
                ...
                <p className="text-gray-500 text-center text-lg lg:text-xl mt-5">
                نؤمن بأن نجاحنا يعتمد على التزامنا بمجموعة من القيم الأساسية التي تشكل جوهر عملنا وتوجه استراتيجياتنا:
                </p>
                <div className="flex flex-wrap justify-center items-center gap-8 mt-12">
                    {values?.map((item) => (
                        <div className="bg-gray-100 rounded-md w-full md:w-1/2 lg:w-1/5 p-4 h-80" key={item.id}>
